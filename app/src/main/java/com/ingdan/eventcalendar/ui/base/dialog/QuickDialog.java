...
import com.ingdan.eventcalendar.ui.base.popup.ViewHelper;
...
public class QuickDialog extends Dialog {
     ...
     * 绑定和设置参数
     */
    public QuickDialog apply(QuickDialogBuilder.AlertParams params) {
        // 1.设置布局
        mViewHelper = null;
        ...
        if (ViewGroup.LayoutParams.WRAP_CONTENT == params.mWidth) {
            windowAttributes.width = ViewGroup.LayoutParams.WRAP_CONTENT;
        }
